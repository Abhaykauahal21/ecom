...
export const metadata = {
  title: "Sign In | Kavya Boss Nutrition",
  description: "Sign in to your Kavya Boss Nutrition account to manage your profile, view orders, and complete your checkout.",
};
