    ...
    <div className="space-y-8 max-w-4xl mx-auto pb-10">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground font-medium">Update the details for "{product.name}".</p>
        </div>
      </div>
            ...
            <Card className="border-none shadow-md overflow-hidden">
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="name" name="name" required defaultValue={product.name} placeholder="e.g. Kavya Boss Whey Protein" className={getFieldError("name") ? "border-destructive" : ""} />
                  {getFieldError("name") && <p className="text-[10px] font-bold text-destructive uppercase tracking-wide">{getFieldError("name")}</p>}
                </div>

                <div className="space-y-2">
                  <Label htmlFor="slug" className="font-black uppercase text-[10px] tracking-widest text-muted-foreground">URL Slug</Label>
                  <Input id="slug" name="slug" defaultValue={product.slug} placeholder="e.g. kavya-boss-whey-protein" />
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="description" name="description" required defaultValue={product.description} placeholder="Detailed product description..." className={`min-h-[150px] ${getFieldError("description") ? "border-destructive" : ""}`} />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="space-y-2">
                      <Label htmlFor={`image-${i}`} className="font-black uppercase text-[10px] tracking-widest text-muted-foreground">Image {i} {i === 1 ? "*" : "(Optional)"}</Label>
                      <Input id={`image-${i}`} name="images" required={i === 1} defaultValue={product.images[i-1] || ""} placeholder="https://img3.hkrtcdn.com/..." className={getFieldError(`images[${i-1}]`) ? "border-destructive" : ""} />
                    </div>
                  ))}
                </div>
                <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold">Paste image links from HealthKart, Cloudinary or any public URL. Image 1 will be the primary thumbnail.</p>
            ...
            <Card className="border-none shadow-md overflow-hidden">
              ...
              <CardContent className="p-6 space-y-6">
                <div className="space-y-2">
                  ...
                  <Input id="price" name="price" type="number" step="0.01" required defaultValue={Number(product.price)} placeholder="0.00" className={getFieldError("price") ? "border-destructive" : ""} />
                ...
                <div className="space-y-2">
                  ...
                  <Input id="comparePrice" name="comparePrice" type="number" step="0.01" defaultValue={product.comparePrice ? Number(product.comparePrice) : ""} placeholder="0.00" />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="stock" className="font-black uppercase text-[10px] tracking-widest text-muted-foreground">Inventory Count *</Label>
                  <Input id="stock" name="stock" type="number" required defaultValue={product.stock} placeholder="0" className={getFieldError("stock") ? "border-destructive" : ""} />
            ...
            <Card className="border-none shadow-md overflow-hidden">
              ...
              <CardContent className="p-6 space-y-6">
                <div className="space-y-2">
                  ...
                  <Input id="brand" name="brand" required defaultValue={product.brand} placeholder="e.g. Kavya Boss" className={getFieldError("brand") ? "border-destructive" : ""} />
                ...
                <div className="space-y-2">
                  ...
                  <Input id="category" name="category" required defaultValue={product.category?.name} placeholder="e.g. Whey Protein" className={getFieldError("categoryName") ? "border-destructive" : ""} />
            ...
            <Card className="border-none shadow-md overflow-hidden">
              ...
              <CardContent className="p-6 space-y-6">
                <div className="flex items-center space-x-3">
                  <Checkbox id="isActive" name="isActive" defaultChecked={product.isActive} className="h-5 w-5" />
